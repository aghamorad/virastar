...
export const MODES: WritingMode[] = [
  ...
  },
  {
    ...
    instruction:
      'این متن را به فارسی رسمی و حرفه‌ای بازنویسی کن؛ مناسب ایمیل و مکاتبهٔ کاری. جمله‌ها را بازسازی کن، جمله‌های کوتاه و پریشان را به هم پیوند بده، لحن را مودبانه و بی‌آلایش کن و از تعارفِ بی‌معنی دوری کن. معنا و منظور نویسنده را حفظ کن. فقط متن بازنویسی‌شده را برگردان.',
  },
  {
    id: 'daneshgahi',
    label: 'دانشگاهی',
    ...
    instruction:
      'این متن را به زبان دانشگاهی و علمی بازنویسی کن؛ واضح، دقیق و منظم. جمله‌ها را بازسازی کن، استدلال را منظم کن و به‌هم‌ریختگی گفتار را برطرف کن. از تورم ادبیات علمی بی‌معنی پرهیز کن. معنا را حفظ کن. فقط متن بازنویسی‌شده را برگردان.',
  },
  {
    id: 'edari',
    label: 'اداری',
    ...
    instruction:
      'این متن را به زبان اداری رسمی بازنویسی کن؛ مناسب درخواست و نامهٔ اداری. جمله‌ها را منظم و مؤدبانه بازسازی کن، از پرگویی بکاه و به چارچوب متعارف مکاتبهٔ اداری نزدیک شو. معنا را حفظ کن. فقط متن بازنویسی‌شده را برگردان.',
  },
  {
    id: 'khodmani',
    label: 'خودمانی',
    ...
    instruction:
      'این متن را به زبان خودمانی و روزمره بازنویسی کن؛ طبیعی، گرم و روان، مثل یک پیام واقعی. جمله‌ها را بازسازی کن تا به گفت‌وگوی روزانه نزدیک شوند، بدون افراط در اصطلاح کوچه. معنا را حفظ کن. فقط متن بازنویسی‌شده را برگردان.',
  },
  {
    id: 'adabi',
    label: 'ادبی',
